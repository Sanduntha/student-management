          ...
          <Box flex={1} display="flex" flexDirection="column" alignItems="center" sx={{ px: 4 }}>
            <Box flex={1} display="flex" flexDirection="column" justifyContent="center" alignItems="center">
              {/* <ToggleButtonGroup sx={{ mb: 2 }}>
                ...
                <ToggleButton
                  value="register"
                  onClick={() => switchPage("register")} // ✅ Add switch function
                  sx={{
                    width: 100,
                    borderRadius: 20,
            ...
            <TextField label="Email" variant="outlined" sx={{ mb: 2, width: 398, marginLeft: -6, marginBottom: 2 }} />
            <TextField label="Password" variant="outlined" type="password" sx={{ mb: 2, width: 398, marginLeft: -6 }} />
            <TextField label="Password" variant="outlined" type="password" sx={{ mb: 2, width: 398, marginLeft: -6 }} />
            <TextField label="Re-Enter Password" variant="outlined" type="password" sx={{ mb: 2, width: 398, marginLeft: -6 }} />
            <Button
              variant="contained"
              sx={{
                mb: 2,
